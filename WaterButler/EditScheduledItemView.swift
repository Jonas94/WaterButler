    ...
    var body: some View {
            ...
            VStack() {
                ...
                VStack{
                    ...
                    Toggle("Måndag", isOn: isEnabled(day: "mon", scheduledItem: scheduledItem))
                    Toggle("Tisdag", isOn: isEnabled(day: "tue", scheduledItem: scheduledItem))
                    Toggle("Onsdag", isOn: isEnabled(day: "wed", scheduledItem: scheduledItem))
                    Toggle("Torsdag", isOn :isEnabled(day: "thu", scheduledItem: scheduledItem))
                    ...
                    Toggle("Fredag", isOn: isEnabled(day: "fri", scheduledItem: scheduledItem))
                    Toggle("Lördag", isOn: isEnabled(day: "sat", scheduledItem: scheduledItem))
                    Toggle("Söndag", isOn: isEnabled(day: "sun", scheduledItem: scheduledItem))
